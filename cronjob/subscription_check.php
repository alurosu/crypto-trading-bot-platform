...
$sql = 'SELECT id, email, user FROM users WHERE subscription_end_timestamp < '.time().' AND subscription_end_is_notified = 1';
$result = mysqli_query($link, $sql);

if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        $sql = 'UPDATE users SET subscription_end_is_notified = 2 WHERE id = '.$row['id'];
        $update = mysqli_query($link, $sql);

        $sql = 'UPDATE bots SET status = 0 WHERE user_id = '.$row['id'];
        $update = mysqli_query($link, $sql);

        $sql = 'INSERT INTO notifications (user_id, title, description, url) VALUES ('.$row['id'].', "All your bots are inactive", "Subscription ended! Click here to renew", "billing.php")';
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                                Your subscription expired and we disabled all your bots.
                                            </td>
                                        </tr>
                                        <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block" style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                                Renew your subscription by clicking the button below and start trading again.
                                            </td>
                                        </tr>
                                        <tr style="font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        ...
        $body_nohtml = "Your subscription expired and we disabled all your bots. Go to https://pitmanbot.com/billing.php and renew your subscription to start trading again.";
        ...
        try {
            ...
            file_put_contents('subscription_check.txt',$date.'Mail sent successfully to ' . $row['user'].' <'.$row['email'].'>'.PHP_EOL, FILE_APPEND);
        } catch (Exception $e) {
            file_put_contents('subscription_check.txt',$date."Error in sending email. Mailer Error: {$mail->ErrorInfo}".PHP_EOL, FILE_APPEND);
        }
    }
}
?>
